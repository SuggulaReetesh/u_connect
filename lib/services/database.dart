...
class DatabaseMethods {
  Future addManulaRegisterdUserInfoToDB(RegistrationModel data)async{
    return FirebaseFirestore.instance.collection("users").add(RegistrationModel().createJson(data));
  }
