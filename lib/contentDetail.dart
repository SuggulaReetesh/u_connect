...
import 'package:uconnect/commons/fullPhoto.dart';
import 'package:uconnect/controllers/FBCloudStore.dart';
import 'package:uconnect/subViews/threadItem.dart';
...
class _ContentDetail extends State<ContentDetail> {
  ...
  void _moveToFullImage() => Navigator.push(context, MaterialPageRoute(builder: (context) => FullPhoto(imageUrl: widget.postData['postImage'], key: null,)));
