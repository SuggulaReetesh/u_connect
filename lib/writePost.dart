...
class _WritePost extends State<WritePost>{
  ...
  void _postToFB() async {
    ...
    // FBCloudStore.sendPostInFirebase(postID,writingTextController.text,widget.myData,postImageURL);
  ...
  Future<void> _getImageAndCrop() async {
    ...
    // Pick an image
    File imageFileFromGallery = (await _picker.pickImage(source: ImageSource.gallery)) as File;
