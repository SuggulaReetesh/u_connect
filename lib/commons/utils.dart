...
import 'package:uconnect/controllers/localTempDB.dart';
...
class Utils{
  ...
  static List<DocumentSnapshot> sortDocumentsByComment(List<DocumentSnapshot> data){
    ...
    List<int> replyCommentIndex = List<int>.filled(0, 0,growable: true);
    ...
    for(int i = 0; i < _originalData.length; i++){
      if (commentDocuments[_originalData[i]['commentID']] != null){
         var data = commentDocuments[_originalData[i]['commentID']];
        _originalData.insertAll(i+1, data!);
      }
    }
